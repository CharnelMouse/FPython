...
The interpretor handles immediate words, and there are immediate initial words, but users cannot currently define their own, so currently this just allows not interpreting compilation words as special cases.
